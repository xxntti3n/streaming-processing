...
check_service "minio" "$NAMESPACE"
check_service "lakekeeper" "$NAMESPACE"
check_service "lakekeeper-db" "$NAMESPACE"
...
check_pod_running "app=minio" "$NAMESPACE"
check_pod_running "app=lakekeeper" "$NAMESPACE"
check_pod_running "app=lakekeeper-db" "$NAMESPACE"
